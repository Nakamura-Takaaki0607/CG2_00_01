...
//}
//
//Matrix4x4 MakeAffineMatrix(const Vector3& scale, const Vector3& rotate, const Vector3& tranlate) {
...
//Matrix4x4 Inverse(const Matrix4x4& cameraMatrix)
//{
//	float diterminant = 1;//|A|
//	float rectDeterminant = 1.0f / diterminant;
//};
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	swapChainDesc.SwapEffect = DXGI_SWAP_EFFECT_FLIP_DISCARD; // モニタにうつしたら、中身を放棄
